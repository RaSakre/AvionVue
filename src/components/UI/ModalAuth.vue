<template>
    <Teleport to="body">
        <Transition name="modal-auth">
            <div v-if="isOpen && !authStore.isAuth" class="modal-overlay" @click.self="close">
...
const handleRegisterSubmit = (registerData) => {
    authStore.register(registerData.email, registerData.password, registerData.userName);
};
